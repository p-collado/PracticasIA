...
creatures = {}
creatures[1] = {image = "creatures//grunt.png", dimX = 64, dimY = 64}
creatures[2] = {image = "creatures//mage.png", dimX = 24, dimY = 24} 
creatures[3] = {image = "creatures//gryphon.png", dimX = 128, dimY = 128} 
creatures[4] = {image = "creatures//dragon.png", dimX = 64, dimY = 64}
creatures[5] = {image = "creatures//fireball.png", dimX = 33, dimY = 22} 
creatures[6]= {image = "creatures//peon.png", dimX = 34, dimY = 34}
